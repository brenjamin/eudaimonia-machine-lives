...
export const Scene18Outro: React.FC = () => {
	...
	const subscribeDOpacity = interpolate(frame, [fps * 6.5, fps * 6.6], [0, 1], {
		extrapolateLeft: 'clamp',
		extrapolateRight: 'clamp',
	});
	const subscribeDWidth = interpolate(frame, [fps * 6.5, fps * 6.6], [0, 25], {
		extrapolateLeft: 'clamp',
		extrapolateRight: 'clamp',
	});
	...
	const signBrightness = interpolate(
		frame,
		[410, 411, 420, 421, 430, 431, 440, 441, 460, 461, 480, 481],
		[80, 100, 80, 100, 80, 100, 80, 150, 130, 150, 130, 150],
		{
			extrapolateLeft: 'clamp',
			extrapolateRight: 'clamp',
		}
	...
	return (
		<AbsoluteFill style={{transform: `translateX(${slideIn}%)`}}>
			<AbsoluteFill style={{zIndex: 20}}>
				<img
					src={staticFile('work-space-words.png')}
					style={{
						width: '100px',
						position: 'absolute',
						top: '500px',
						left: '350px',
						filter: `brightness(${signBrightness}%) saturate(120%)`,
					}}
					alt=""
				/>
			</AbsoluteFill>
